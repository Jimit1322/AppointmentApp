...
class TopDoctorAdaptor2(val items: MutableList<DoctorModel>): RecyclerView.Adapter<TopDoctorAdaptor2.Viewholder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TopDoctorAdaptor2.Viewholder {
         context=parent.context
        val binding= ViewholderTopDoctor2Binding.inflate(LayoutInflater.from(context),parent,false)
        return Viewholder(binding)
    }

    override fun onBindViewHolder(holder: TopDoctorAdaptor2.Viewholder, position: Int) {
        ...
        holder.binding.degreetxt.text=items[position].Special
